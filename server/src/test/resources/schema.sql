-- Tắt kiểm tra khóa ngoại của H2 để thoải mái DROP và CREATE bảng không lo ràng buộc
...
-- Bật lại kiểm tra khóa ngoại sau khi cấu trúc bảng đã được thiết lập xong
